          ...
          <tbody>
            @foreach($addresses as $address)
              ...
              <tr>
                ...
                <td><a href="/address/{{ $address->id }}" class="btn btn-secondary w-100" role=button>Info</a></td>
                <td><a href="/address/{{ $address->id }}/edit" class="btn btn-primary w-100" role=button>Wijzig</a></td>
                <td>
